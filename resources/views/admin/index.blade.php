...
<html lang="zxx">
    ...
    <head>
        ...
        <link
            rel="stylesheet"
            href="admin_assets/vendors/swiper_slider/css/swiper.min.css"
        />
        ...
        <link
            rel="stylesheet"
            href="admin_assets/vendors/owl_carousel/css/owl.carousel.css"
        />
        ...
        <link
            rel="stylesheet"
            href="admin_assets/vendors/material_icon/material-icons.css"
        />
        ...
        <link
            rel="stylesheet"
            href="admin_assets/css/colors/default.css"
            id="colorSkinCSS"
        />
        ...
        <nav class="sidebar">
            ...
            <ul id="sidebar_menu">
                <li class="{{ Request::path() ==='admin' ? 'mm-active' : ''}}">
                    ...
                    <ul>
                        <li>
                            <a class="{{ Request::path() ==='admin' ? 'active' : ''}}" href="{{ route('admin.home') }}">Default</a>
                        </li>
                    </ul>
                </li>
                    ...
                    <ul>
                        <li>
                            <a href="{{ route('category.index') }}"
                                class="{{ Request::path() == 'admin/category' ? 'active' : ''}}"
                            >Danh sách</a>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            <a href="{{ route('category.create') }}"
                                class="{{ Request::path() == 'admin/category/create' ? 'active' : ''}}"
                            >Thêm mới</a>
                        </li>
                    </ul>
                </li>
                <li class="{{ preg_match('/^admin\/product(\/.*)?$/', Request::path()) ? 'mm-active' : ''}}">
                    ...
                    <ul>
                        <li>
                            ...
                            class="{{ Request::path() == 'admin/product' ? 'active' : ''}}"
                            >Danh sách</a>
                        </li>
                    </ul>
                    <ul>
                        <li>
                            ...
                            class="{{ Request::path() == 'admin/product/create' ? 'active' : ''}}"
                            >Thêm mới</a>
                        </li>
                    </ul>
                </li>
                <li class="{{ preg_match('/^admin\/users(\/.*)?$/', Request::path()) ? 'mm-active' : ''}}">
                    ...
                    <ul>
                        <li>
                            ...
                            class="{{ preg_match('/^admin\/users(\/.*)?$/', Request::path()) ? 'active' : ''}}"
                            >Danh sách</a>
                        </li>
                    </ul>
                </li>
                <li class="{{ preg_match('/^admin\/orders(\/.*)?$/', Request::path()) ? 'mm-active' : ''}}">
                    ...
                    <ul>
                        <li>
                            ...
                            class="{{ Request::path() == 'admin/orders' ? 'active' : ''}}"
                            >Danh sách</a>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="serach_field-area">
                                <div class="search_inner">
                                    <form action="#">
                                        ...
                                        <button type="submit">
                                            <img
                                                src="admin_assets/img/icon/icon_search.svg"
                                                alt
                                            />
                                        </button>
                                    </form>
                                            ...
                                            <div class="Notification_body">
                                                ...
                                                >
                                                    <div class="notify_thumb">
                                                        <a href="#"
                                                            ><img
                                                                src="admin_assets/img/staf/2.png"
                                                                alt
                                                        /></a>
                                                    </div>
                                                ...
                                                >
                                                    <div class="notify_thumb">
                                                        <a href="#"
                                                            ><img
                                                                src="admin_assets/img/staf/4.png"
                                                                alt
                                                        /></a>
                                                    </div>
                                                    <div class="notify_content">
                                                ...
                                                >
                                                    <div class="notify_thumb">
                                                        <a href="#"
                                                            ><img
                                                                src="admin_assets/img/staf/3.png"
                                                                alt
                                                        /></a>
                                                    </div>
                                                    <div class="notify_content">
